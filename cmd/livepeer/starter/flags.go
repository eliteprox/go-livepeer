...
func NewLivepeerConfig(fs *flag.FlagSet) LivepeerConfig {
	...
	cfg.RemoteSignerJWKSUrl = fs.String("remoteSignerJWKSUrl", *cfg.RemoteSignerJWKSUrl, "JWKS endpoint URL for JWT verification on the remote signer (e.g., https://livepeer.ai/.well-known/jwks.json)")
