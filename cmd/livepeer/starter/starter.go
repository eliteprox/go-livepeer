...
type LivepeerConfig struct {
	...
	RemoteSignerUsageIdentityMode *string
...
func DefaultLivepeerConfig() LivepeerConfig {
	...
	defaultRemoteSignerUsageIdentityMode := "none"
	...
	return LivepeerConfig{
		...
		RemoteSignerUsageIdentityMode: &defaultRemoteSignerUsageIdentityMode,
...
func StartLivepeer(ctx context.Context, cfg LivepeerConfig) {
	...
	if cfg.RemoteSignerUsageIdentityMode != nil {
		n.RemoteSignerUsageIdentityMode = strings.TrimSpace(*cfg.RemoteSignerUsageIdentityMode)
	}
