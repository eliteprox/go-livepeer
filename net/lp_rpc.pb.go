...
type OrchestratorInfo struct {
	...
	// External/BYOC capabilities registered with this orchestrator
	ExternalCapabilities []*ExternalCapabilityInfo `protobuf:"bytes,36,rep,name=external_capabilities,json=externalCapabilities,proto3" json:"external_capabilities,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *OrchestratorInfo) GetExternalCapabilities() []*ExternalCapabilityInfo {
	if x != nil {
		return x.ExternalCapabilities
	}
	return nil
}
...
// External/BYOC capability information
type ExternalCapabilityInfo struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Name of the external capability (e.g., "comfystream", "text-reversal")
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	// Human-readable description of the capability
	Description string `protobuf:"bytes,2,opt,name=description,proto3" json:"description,omitempty"`
	// Total capacity available for this capability
...
func (x *ExternalCapabilityInfo) Reset() {
	*x = ExternalCapabilityInfo{}
	mi := &file_net_lp_rpc_proto_msgTypes[28]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ExternalCapabilityInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ExternalCapabilityInfo) ProtoMessage() {}

func (x *ExternalCapabilityInfo) ProtoReflect() protoreflect.Message {
	mi := &file_net_lp_rpc_proto_msgTypes[28]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ExternalCapabilityInfo.ProtoReflect.Descriptor instead.
func (*ExternalCapabilityInfo) Descriptor() ([]byte, []int) {
	return file_net_lp_rpc_proto_rawDescGZIP(), []int{28}
}

func (x *ExternalCapabilityInfo) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *ExternalCapabilityInfo) GetDescription() string {
	if x != nil {
...
func (x *ExternalCapabilityInfo) GetCapacity() int32 {
	if x != nil {
		return x.Capacity
	}
	return 0
...
func (x *ExternalCapabilityInfo) GetCapacityInUse() int32 {
	if x != nil {
...
const file_net_lp_rpc_proto_rawDesc = "" +
	...
	"\x05value\x18\x02 \x01(\v27.net.Capabilities.CapabilityConstraints.ModelConstraintR\x05value:\x028\x01\"\x9f\x04\n" +
	...
	"\x05nodes\x18\" \x03(\tR\x05nodes\x12P\n" +
	"\x15external_capabilities\x18$ \x03(\v2\x1b.net.ExternalCapabilityInfoR\x14externalCapabilities\"`\n" +
	"\tAuthToken\x12\x14\n" +
...
var file_net_lp_rpc_proto_goTypes = []any{
	...
	(*ExternalCapabilityInfo)(nil),             // 33: net.ExternalCapabilityInfo
...
var file_net_lp_rpc_proto_depIdxs = []int32{
	...
	33, // 13: net.OrchestratorInfo.external_capabilities:type_name -> net.ExternalCapabilityInfo
